...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">  
	...
	<!--Events --> 
		...
		<div class="container">
		<h2 class="heading-agileinfo">Shows Management Companies<span></span></h2>
				<div class="popular-grids">
					<?php
						include 'db.php';
						$query = "SELECT * FROM organizers WHERE category='show'";
					...
					<div class="col-md-4 popular-grid">
						...
						<div class="popular-text">
							<h5><a href="#" data-toggle="modal" data-target="#myModal2">Show</a></h5>
